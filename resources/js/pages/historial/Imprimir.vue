...
interface ColaboradorRef { id: number; nombre: string; apellidos: string; tipo?: string; perfil?: PerfilBancario | null }
...
const props = defineProps<{ nomina: NominaRecord }>();

const n = props.nomina;
...
<template>
    <Head title="Comprobante de Nómina" />
    ...
    <div class="print-container min-h-screen bg-slate-100 p-4 print:m-0 print:bg-white print:p-0">
        ...
        <div class="mx-auto max-w-4xl bg-white shadow-lg print:shadow-none">
            ...
            <div class="border-b-2 border-slate-800 px-8 pb-4 pt-6">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <h1 class="text-2xl font-bold uppercase tracking-tight text-slate-900">Comprobante de Nómina</h1>
            ...
            <div class="grid grid-cols-2 gap-6 border-b px-8 py-4">
                <div>
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-900">{{ n.tipo_colaborador }}</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm font-medium" :class="n.estado === 'PAGADO' ? 'text-emerald-600' : 'text-amber-600'">
                        {{ n.estado === 'PAGADO' ? 'PAGADA' : 'PENDIENTE' }}
                    </p>
                </div>
                <div>
                    <p class="text-xs font-medium uppercase tracking-wide text-slate-500">Fecha de cálculo</p>
                    <p class="mt-0.5 text-sm text-slate-900">{{ fmtFecha(n.fecha_calculo?.slice(0, 10)) }}</p>
                </div>
            </div>
            ...
            <div class="px-8 py-4">
                ...
                <h2 class="mb-3 text-sm font-semibold uppercase tracking-wide text-slate-700">Resumen de Nómina</h2>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr v-if="n.tipo_colaborador === 'COLABORADOR BASE' || n.tipo_colaborador === 'CONDUCTOR BASE'">
                            ...
                            <td class="py-2 text-right text-slate-600">
                                {{ n.dias }} días × {{ fmt(n.sueldo_diario) }}
                            </td>
            ...
            <div v-if="n.desglose" class="border-t px-8 py-4">
                <h2 class="mb-3 text-sm font-semibold uppercase tracking-wide text-slate-700">Detalle</h2>
