...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Archivos incluidos: solo el storage de la aplicación (documentos de
                 * identidad, evidencias de asistencia, branding). El código está en git
                 * y no requiere respaldo. Se excluyen framework/sessions/cache/logs
                 * (transitorios) y backups (para evitar recursión).
                 */
                'include' => [
                    storage_path('app'),
                ],
